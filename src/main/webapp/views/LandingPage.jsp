   ...
   <div class="modal-content">
     ...
     <div class="modal-body">
       <form action="${pageContext.request.contextPath}/ngo/register" method="post" enctype="multipart/form-data" id="ngoRegisterForm">
         ...
         <hr>
         <!-- Contact Info -->
         <h6 class="text-success fw-bold">Contact Information</h6>
         <div class="row">
           <div class="col-md-6 mb-3">
         ...
         <hr>
         <!-- Banking Info -->
         <h6 class="text-success fw-bold">Banking Details</h6>
         <div class="row">
           <div class="col-md-6 mb-3">
         ...
         <hr>
         <!-- Operational Scope -->
         <h6 class="text-success fw-bold">Operational Scope</h6>
         <div class="row">
           <div class="col-md-6 mb-3">
         ...
         <h6 class="text-success fw-bold">Location</h6>
         <div class="row">
           <div class="col-md-6 mb-3">
         ...
         <div class="d-grid mt-3">
           <button type="submit" class="btn btn-success btn-lg">Register NGO</button>
         </div>
       </form>
     </div>
   </div>
